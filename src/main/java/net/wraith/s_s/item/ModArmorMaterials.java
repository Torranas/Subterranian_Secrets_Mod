...
public enum ModArmorMaterials implements ArmorMaterial {
    MALACHITE("malachite", 25, new int[]{3,6,8,3}, 13, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.4f, 0.1f, () -> {
        return Ingredient.of(ModItems.MALACHITE.get());
    });
    ...
    public String getName() {
        return SubterraneanSecrets.MOD_ID + ":" + this.name;
    }
